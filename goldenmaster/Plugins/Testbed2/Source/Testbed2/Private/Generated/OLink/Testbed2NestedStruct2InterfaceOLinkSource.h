...
DECLARE_LOG_CATEGORY_EXTERN(LogTestbed2NestedStruct2InterfaceOLinkSource, Log, All);
...
{
public:
	explicit Testbed2NestedStruct2InterfaceOLinkSource();
	virtual ~Testbed2NestedStruct2InterfaceOLinkSource() = default;
