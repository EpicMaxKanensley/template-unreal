...
UTbSame1SameStruct2InterfaceOLinkClient::UTbSame1SameStruct2InterfaceOLinkClient()
	...
	, _SentData(MakeUnique<TbSame1SameStruct2InterfacePropertiesData>())
#else
...
void UTbSame1SameStruct2InterfaceOLinkClient::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	{
		UE_LOG(LogTbSame1SameStruct2InterfaceOLinkClient, Warning, TEXT("No valid olink connection for the %s client, please set in the ApiGear TbSame1 plugin settings or during run time"), UTF8_TO_TCHAR(m_sink->olinkObjectName().c_str()));
		return;
	}
...
void UTbSame1SameStruct2InterfaceOLinkClient::SetProp1_Implementation(const FTbSame1Struct2& InProp1)
{
	if (!m_sink->IsReady())
	{
		UE_LOG(LogTbSame1SameStruct2InterfaceOLinkClient, Warning, TEXT("%s has no node"), UTF8_TO_TCHAR(m_sink->olinkObjectName().c_str()));
		return;
	}
