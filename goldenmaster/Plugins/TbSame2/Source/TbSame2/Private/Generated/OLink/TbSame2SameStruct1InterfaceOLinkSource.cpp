...
DEFINE_LOG_CATEGORY(LogTbSame2SameStruct1InterfaceOLinkSource);
...
void TbSame2SameStruct1InterfaceOLinkSource::setBackendService(TScriptInterface<ITbSame2SameStruct1InterfaceInterface> InService)
{
	...
	{
		UE_LOG(LogTbSame2SameStruct1InterfaceOLinkSource, Error, TEXT("Cannot set backend service - interface TbSame2SameStruct1Interface is not fully implemented"));
		return;
	}
...
void TbSame2SameStruct1InterfaceOLinkSource::setOLinkHost(TSoftObjectPtr<UOLinkHost> InHost)
{
	Host = InHost.Get();
}
...
nlohmann::json TbSame2SameStruct1InterfaceOLinkSource::olinkInvoke(const std::string& methodId, const nlohmann::json& args)
{
	if (!BackendService)
	{
		UE_LOG(LogTbSame2SameStruct1InterfaceOLinkSource, Error, TEXT("No backend service set - please specify a service in the adapter TbSame2SameStruct1InterfaceOLinkAdapter which implements the TbSame2SameStruct1Interface interface"));
